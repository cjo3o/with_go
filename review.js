    ...
    div.innerHTML = `
        <div class="review-content">
            <div class="review-text">
                ${
                  item.is_best
                    ? `<div class="best-badge"><img src="../src/images/best.png" alt="BEST" class="best-icon" /></div>`
                    : ""
                }
                <div class="title">
            ...
            <div class="review-image-box">
                ${
                  item.file_url
                    ? `<img src="${item.file_url}" class="review-image" />`
                    : ""
                }
            </div>
        </div>
...
function openModal(review) {
  ...
  modalBody.innerHTML = `
    <h2>
        ${
          review.is_best
            ? `<img src="../src/images/best.png" alt="BEST" class="best-icon" /> `
            : ""
        }
    ...
    ${
      review.file_url
        ? `<div class="image-box"><img src="${review.file_url}" /></div>`
        : ""
    }
`;
